...
const (
	Authentication_SignUp_FullMethodName = "/authentication.Authentication/SignUp"
...
type AuthenticationClient interface {
	SignUp(ctx context.Context, in *Credentials, opts ...grpc.CallOption) (*Credentials, error)
	Login(ctx context.Context, in *Credentials, opts ...grpc.CallOption) (*Credentials, error)
}
...
func (c *authenticationClient) SignUp(ctx context.Context, in *Credentials, opts ...grpc.CallOption) (*Credentials, error) {
	out := new(Credentials)
	err := c.cc.Invoke(ctx, Authentication_SignUp_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authenticationClient) Login(ctx context.Context, in *Credentials, opts ...grpc.CallOption) (*Credentials, error) {
	out := new(Credentials)
...
type AuthenticationServer interface {
	SignUp(context.Context, *Credentials) (*Credentials, error)
	Login(context.Context, *Credentials) (*Credentials, error)
...
func (UnimplementedAuthenticationServer) SignUp(context.Context, *Credentials) (*Credentials, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SignUp not implemented")
}
func (UnimplementedAuthenticationServer) Login(context.Context, *Credentials) (*Credentials, error) {
...
func _Authentication_SignUp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthenticationServer).SignUp(ctx, req.(*Credentials))
	}
